...
//  Delegasyon doğru yerde: sadece .gallery üzerinde!
galleryItem.addEventListener("click", (event) => {
  event.preventDefault();

  const target = event.target;

  //  Yalnızca galeri içindeki img öğelerine tıklamaya izin verilir
  ...
  //  Escape ile modal kapatma sadece modal açıkken dinlenir
